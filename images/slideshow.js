        ...
        setup: function () {
            ...
            if (this.settings.images_links.length > 1) {
                ...
                this.box_skitter.find(".next_button, .prev_button").hover(function () {
                    b(this).stop().animate() //{ opacity: 0.5 }, 200 2014.07.19ÐÞ¸Ä
                }, function () {
                    b(this).stop().animate()//{ opacity: 1 }, 200 2014.07.19ÐÞ¸Ä
                });
...
(function () {
    jQuery.noConflict();
    jQuery('#slideshow').skitter({ width: 1680, height: 480, animation: 'fade', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a target="_blank" href="/"><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 1500, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
    jQuery('#service_slideshow').skitter({ width: 726, height: 400, animation: 'fade', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a target="_blank" href="/"><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 1500, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
    jQuery('#news_slideshow').skitter({ width: 310, height: 150, animation: 'fade', structure: '<a href="#" class="prev_button">prev</a>' + '<a href="#" class="next_button">next</a>' + '<span class="info_slide"></span>' + '<div class="container_skitter">' + '<div class="image">' + '<a target="_blank" href="/"><img class="image_main" /></a>' + '<div class="label_skitter"></div>' + '</div>' + '</div>', velocity: 1.3, interval: 1500, thumb_width: '70px', thumb_height: '40px', caption: 'bottom', caption_width: '250', navigation: 1, fullscreen: false })
})();
